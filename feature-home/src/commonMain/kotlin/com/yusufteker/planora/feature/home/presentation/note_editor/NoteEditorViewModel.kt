...
class NoteEditorViewModel(
    ...
    private val cloudAiManager: com.yusufteker.planora.core.ai.CloudAiManager
) : ViewModel() {
    ...
    fun onEvent(event: NoteEditorEvent) {
        when (event) {
            ...
            is NoteEditorEvent.OnAddChecklistItem -> {
                val newItem = com.yusufteker.planora.shared.api.SubTask(
                    id = com.yusufteker.planora.core.utils.generateUUID(),
                    title = event.title,
                    isDone = false
                )
    ...
    private fun parseContentAndChecklist(content: String): Pair<String, List<com.yusufteker.planora.shared.api.SubTask>> {
        val lines = content.lines()
        val newContentLines = mutableListOf<String>()
        val newChecklist = mutableListOf<com.yusufteker.planora.shared.api.SubTask>()
        ...
        for (line in lines) {
            ...
            if (match != null) {
                ...
                newChecklist.add(
                    com.yusufteker.planora.shared.api.SubTask(
                        id = com.yusufteker.planora.core.utils.generateUUID(),
                        title = itemTitle,
                        isDone = false
                    )
    ...
    private fun loadNote(
        ...
        if (noteId == null) {
            val formattedDate = com.yusufteker.planora.core.utils.formatFullDate(com.yusufteker.planora.core.utils.getCurrentTimeMs())
        ...
        viewModelScope.launch {
            ...
            planRepository.observeAllTasks().collect { tasks ->
                ...
                if (note != null) {
                    val formattedDate = com.yusufteker.planora.core.utils.formatFullDate(note.startTime)
