...
import planora.core.generated.resources.action_register
import planora.core.generated.resources.action_send_register_code
import planora.core.generated.resources.action_verify_and_register
import planora.core.generated.resources.already_have_account_prompt
import planora.core.generated.resources.confirm_password
import planora.core.generated.resources.email
import planora.core.generated.resources.hide_password
import planora.core.generated.resources.name
import planora.core.generated.resources.password
import planora.core.generated.resources.register_step2_subtitle
import planora.core.generated.resources.register_subtitle
import planora.core.generated.resources.reset_code_label
import planora.core.generated.resources.show_password
import planora.core.generated.resources.username

/**
 * Register screen composable with two-step email verification workflow.
 */
@Composable
fun RegisterScreen(
    ...
    Column(
        ...
        if (state.isCodeSent) {
            Row(
                ...
                IconButton(
                    onClick = { viewModel.onEvent(RegisterEvent.BackToFormClicked) }
                ) {
                    Icon(
        ...
        Text(
            text = if (state.isCodeSent) {
                stringResource(Res.string.register_step2_subtitle)
            } else {
        ...
        if (!state.isCodeSent) {
            ...
            Button(
                onClick = { viewModel.onEvent(RegisterEvent.SendCodeClicked) },
                ...
                if (state.isLoading) {
                    ...
                    Text(
                        text = stringResource(Res.string.action_send_register_code),
            ...
            OutlinedTextField(
                value = state.code,
                onValueChange = { if (it.length <= 6) viewModel.onEvent(RegisterEvent.CodeChanged(it)) },
            ...
            Button(
                ...
                if (state.isLoading) {
                    ...
                    Text(
                        text = stringResource(Res.string.action_verify_and_register),
                        style = MaterialTheme.typography.labelLarge
                    )
                }
            }
