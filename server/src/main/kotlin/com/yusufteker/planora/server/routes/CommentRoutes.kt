...
import com.yusufteker.planora.server.database.tables.CommentsTable
        ...
        route("/posts/{postId}/comments") {
            ...
            post {
                ...
                val newCommentDto = dbQuery {
                    ...
                    com.yusufteker.planora.shared.api.CommentResponse(
                        ...
                        replies = emptyList<com.yusufteker.planora.shared.api.CommentResponse>()
                    )
                }
