        ...
        jwt("auth-jwt") { // Use "auth-jwt" as the name for this authentication provider
            ...
            verifier( // Configure the JWT verifier with the secret, issuer, and audience
                JWT
                    ...
                    .withAudience("planora-client") // Bu tokenın hangi client için geçerli olduğunu belirler. Örneğin, birden fazla client varsa (web, mobile), her biri için farklı audience belirlenebilir.
                    .withIssuer(issuer)
                    .build()
            )
            validate { credential ->
